...
namespace BEAMDT.Classes
{
    ...
    public static class ProcessCE
    {
        ...
        [DllImport("coredll.dll", SetLastError = true)]
        private static extern bool KernelIoControl(uint dwIoControlCode, IntPtr lpInBuf, uint nInBufSize, IntPtr lpOutBuf, uint nOutBufSize, ref uint lpBytesReturned);
