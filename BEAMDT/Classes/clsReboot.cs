...
namespace BEAMDT.Classes
{
    class clsReboot
    {
        ...
        public static uint PowerOff()
        {
            //SetCleanRebootFlag();
            return SetSystemPowerState(null, (int)POWER_STATE.OFF, POWER_FORCE);
        }
        ...
        {
            ExitWindowsEx((uint)ExitWindowsAction.EWX_REBOOT, (uint)0);
        }
        public static void shutdownDevice()
        {
            ExitWindowsEx((uint)ExitWindowsAction.EWX_POWEROFF, (uint)0);
        }
    }
}
